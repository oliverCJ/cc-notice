export const enMessages = {
  ...
  customFaceEditor: {
    ...
    workbench: { initialStatus: 'Choose a tool and work on the canvas.', toolHints: { select: 'Drag on the canvas to create a selection, then use selection actions on the right.', brush: 'Click a pixel to toggle its highlighted state.', eraser: 'Adjust the erase area, then drag and release to apply it.', line: 'Press to set the start, drag to preview, and release to apply.', rectangle: 'Drag to preview the rectangle, then release to apply.', circle: 'Drag a bounding box; preview and final ellipse use the same bounds.', triangle: 'The first click fixes the vertex; drag to adjust the base.', pen: 'Click points to create a path, then finish with double-click or the button.' }, constraints: { line: 'Constrain to horizontal, vertical, or 45°', rectangle: 'Constrain to a square', circle: 'Constrain to a circle', triangle: 'Constrain to an isosceles triangle' },
      back: 'Back to groups', save: 'Save', saving: 'Saving...', importSvg: 'Import SVG', importImage: 'Import Image', assets: 'Assets', groupName: 'Group name', applyGroupName: 'Apply group name', modified: 'Unsaved changes', saved: 'Saved', saveFailed: 'Save failed: {{error}}', saveSuccess: 'Face group saved.', saveConflict: 'Save conflict: the face group changed on disk.', reloadSuccess: 'Disk version reloaded; local unsaved changes were discarded.', reloadFailed: 'Reload failed: {{error}}', discardFailed: 'Failed to discard changes: {{error}}', closeFailed: 'Failed to close editor: {{error}}', imagePixelizerOpen: 'The image import window is open. Close it before leaving the editor.', imageVectorizerOpen: 'The image to SVG window is open. Close it before leaving the editor.', switchFace: 'Switched face and loaded its first frame.', frameAdded: 'Copied the current frame and appended it to the timeline.', blankFrameAdded: 'Created a blank frame and appended it to the timeline.', faceRenamed: 'Renamed to “{{name}}”.', maxFaces: 'A group can contain up to 15 faces.', newFace: 'New face', copyFace: 'Copy face', addedFace: 'Added “{{name}}”.', copySuffix: 'copy', copiedFace: 'Copied as “{{name}}”.', emptyFaceName: 'Face name cannot be empty.', duplicateFaceName: 'Face names must be unique within a group.', minFaces: 'A group must keep at least one face.', deleteFaceConfirm: 'Delete face “{{name}}”?', groupNameChanged: 'Group name changed to “{{name}}”.', frameApplied: 'Temporary object applied to the current frame.', copiedSelection: 'Selection copied. You can paste it after switching frames.', selectionShape: 'Selection Shape', selectionShapeRectangle: 'Rectangle', selectionShapeCircle: 'Circle', selectionCreated: 'Selected a {{width}} × {{height}} pixel area.', imageApplied: 'Image loaded onto the canvas. Adjust it and confirm to apply.', imageImportSizeMismatch: 'The imported image result does not match the current canvas. Import it again.', assetApplied: 'Personal asset loaded onto the canvas. Adjust it and confirm to apply.', assetSaved: 'Current frame saved as a personal asset.', svgApplied: 'SVG loaded onto the canvas. Adjust its position and confirm the import.', currentFace: 'Current face', selectFace: 'Select face', faceName: 'Face name', currentFrame: 'Frame {{current}} / {{total}}', applyName: 'Apply name', defaultFace: 'Default', setDefault: 'Set as default face', deleteFace: 'Delete face', frameName: 'Frame', frameDuration: 'Frame duration', resolutionFaces: 'Resolution {{width}} × {{height}} · faces {{count}} / 15', toolProperties: 'Tool properties', currentTool: 'Current tool: {{tool}}', outline: 'Outline', filled: 'Filled', eraseArea: 'Erase area: {{size}} × {{size}}', start: 'Start: {{point}}', end: 'End: ' + '{{point}}', bounds: 'Bounds: {{width}} × {{height}}', selectionInfo: 'Selection: {{x}},{{y}} · {{width}} × {{height}}', moveSection: 'Move', rotationSection: 'Rotate', selectionActions: 'Selection actions', cancelSelection: 'Cancel selection', moveStep: 'Selection move step', rotationPivot: 'Rotation pivot: {{x}},{{y}}', setRotationPivot: 'Set rotation pivot', pickRotationPivot: 'Choose a rotation pivot on the canvas', rotationDegrees: 'Rotation angle', decreaseRotation: 'Decrease rotation angle', increaseRotation: 'Increase rotation angle', rotateClockwise: 'Rotate clockwise 90°', rotateCounterclockwise: 'Rotate counterclockwise 90°', confirmTransform: 'Confirm transform', cancelTransform: 'Cancel transform', confirmRotation: 'Confirm rotation', cancelRotation: 'Cancel rotation', up: 'Move selection up', left: 'Move selection left', down: 'Move selection down', right: 'Move selection right', confirmMove: 'Confirm move', copy: 'Copy', paste: 'Paste', pasteHint: 'Paste at the top-left of the current selection', clipboardEmpty: 'Clipboard is empty. Copy a selection first.', selectTarget: 'Select a paste target area first.', clear: 'Clear', highlight: 'Highlight', dim: 'Turn off', cancelMove: 'Cancel move', cancel: 'Cancel', selectHint: 'Drag on the canvas to create a selection.', points: 'Points: {{count}}', finishPath: 'Finish path', cancelPath: 'Cancel path', saveConflictTitle: 'Save conflict detected', saveConflictDescription: 'The face group changed on disk. Reloading discards local changes; overwriting replaces the disk version with the local version.', reloadDisk: 'Reload disk version', overwrite: 'Overwrite', leaveTitle: 'Save unfinished changes?', leaveDescription: 'The current face group has unsaved changes. The editor stays open if saving fails.', discard: 'Discard changes', saveAndClose: 'Save and close', pendingTitle: 'Asset pending confirmation', pendingDescription: 'Drag on the canvas to adjust its position, then confirm to write it to the current frame.', pendingScale: 'Scale: {{scale}}', pendingScaleLabel: 'Pending asset scale', copyFirst: 'Copy a selection first', cancelApply: 'Cancel apply', confirmApply: 'Apply', pasteTarget: 'Select a paste target area first.' },
    imagePixelizer: {
      title: 'Image Import',
      ...
      sourceGroup: 'Source',
      sourceHint: 'Image mode uses the existing import flow. Text mode first renders a transparent bitmap and then converts it.',
      sourceImage: 'Image',
      sourceText: 'Text',
      ...
      textContentHint: 'Supports multiple lines. Overflow does not block conversion; adjust with scale and position.',
      textTooLongWarning: 'This text is long and may affect conversion performance.',
      textTruncatedWarning: 'Text was too long and has been truncated for the current canvas and font size.',
      fontFamily: 'Font',
      ...
      fontSize: 'Font size',
      fontSizeHint: 'Controls source text size. Use image scale to adjust the whole object afterward.',
      ...
      modeMono: 'Monochrome',
      modeColor: 'Color',
      modeHint: 'Monochrome outputs pixels that can be applied directly, while color mode is for previewing and tuning.',
      colorCount: 'Color count',
      colorCountHint: 'In color mode this limits the preview palette size; monochrome mode ignores it.',
      threshold: 'Threshold',
      thresholdHint: 'Lower thresholds keep more bright pixels; higher thresholds tighten edges.',
      contrast: 'Contrast',
      contrastHint: 'Higher contrast spreads light and dark values apart; lower contrast softens the result.',
      brightness: 'Brightness',
    ...
    svgImport: { title: 'Import SVG', filterName: 'SVG image', mergeLabel: 'Merge into current frame', replaceLabel: 'Replace current frame', description: 'Convert SVG using native static rendering into monochrome pixels. Transparent backgrounds and opaque foregrounds are recommended; opaque backgrounds are also lit.', read: 'Reading...', selectFile: 'Choose SVG file', importImage: 'Create from image', metadata: 'Source {{width}} × {{height}} · {{elements}} elements · target {{targetWidth}} × {{targetHeight}}', noFile: 'Choose an SVG file', updating: 'Updating preview...', mode: 'Import mode', merge: 'Merge', replace: 'Replace', x: 'Horizontal position X', y: 'Vertical offset', offsetXLabel: 'Horizontal offset', offsetYLabel: 'Vertical offset', scaleLabel: 'Scale', rotationLabel: 'Rotation', thresholdLabel: 'Pixel coverage threshold', recognitionMode: 'Pixel recognition', alphaRecognition: 'By transparency', alphaRecognitionLabel: 'Recognize pixels by transparency', alphaRecognitionHint: 'For transparent-background artwork; brightness is ignored.', brightnessRecognition: 'By brightness', brightnessRecognitionLabel: 'Recognize pixels by brightness', brightnessRecognitionHint: 'For white-background dark artwork; darker pixels become highlights while transparent pixels stay off.', decrease: 'Decrease {{field}}', increase: 'Increase {{field}}', center: 'Center', topLeft: 'Top left', reset: 'Reset', offsetX: 'Horizontal offset: {{value}}', offsetY: 'Vertical offset: {{value}}', scale: 'Scale: {{value}}', rotation: 'Rotation: {{value}}°', threshold: 'Pixel coverage threshold: {{value}}', thresholdHint: 'Lower values preserve more fine lines; higher values tighten edges.', activePixels: 'Highlighted pixels: {{count}}', clipped: 'Content outside the screen was clipped', cancel: 'Cancel', apply: 'Apply to current frame', preview: 'SVG preview {{width}} × {{height}}' },
    imageVectorizer: {
      title: 'Image to SVG',
      selectImage: 'Choose Image',
      selectedFile: 'Selected image: {{name}}',
      ...
      offsetXHint: 'Drag or fine tune the converted image horizontally on the preprocessing canvas.',
